...
The programme can be divide into 2 parts. the first one corrosponds to the 
...
class Field:
    ...
    def __init__(self, name,indices,**kwargs):
        ...
        #of the indices, secong is the sign of the indices(+1 or -1)
